...
public class PropertyManagementPropertyType extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final String[] property = this.getResources().getStringArray(R.array.PropertyManagementPropertyType);
